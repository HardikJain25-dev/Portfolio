...
export default function Pageproject() {
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 max-[430px]:grid-cols-1">
                        <Image
                            ...
                            width={500}
                            height={500}
                            className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] max-[430px]:h-28"
                        />
                        <Image
    ...
    return (
        <>
            <div className="">
                <div className="bg-white w-full h-[80vh] flex p-20 gap-80 max-[430px]:flex-col max-[430px]:p-4 max-[430px]:gap-6 ">
                    <div className="w-130 h-130 border rounded-[40px] flex-end bg-black max-[430px]:w-full max-[430px]:h-90">
                        <KnotAnimation />
                    </div>
                    <div className="flex min-h-screen pt-50 justify-center bg-white max-[430px]:min-h-0 max-[430px]:pt-14  ">
                        <p className="text-lg text-gray-800 max-[430px]:text-base">
                            ...
                            <HoverPeek url="https://github.com/creepolite">
                                <a
                                    ...
                                    className="font-medium text-blue-600 text-[3vh] underline decoration-blue-400 decoration-dotted hover:text-blue-800 hover:decoration-blue-600 hover:decoration-solid gap-2 max-[430px]:text-base"
                                >
                                    GitHub
                                </a>
                            </HoverPeek>
                            <HoverPeek url="https://www.linkedin.com/in/hardik-jain-25518126a/">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="font-medium text-blue-600 text-[3vh] underline decoration-blue-400 decoration-dotted hover:text-blue-800 hover:decoration-blue-600 hover:decoration-solid ml-2 max-[430px]:text-base"
                                >
                                    LinkedIn
                                </a>
                            </HoverPeek>
